...
public:
	...
	// 从目标数据表中查询数据值
	static BOOL SelectData(CString TableName, CString &pResult, CString Column, CString Params = _T(""),bool Console = false, CString Order = _T(""), CString Limit = _T(""), int SortMode = MOD_ASC, BOOL DISTINCT = FALSE, CString COUNT = _T(""), CString COLUMN = _T(""), CString GROUP = _T(""), CString HAVING = _T(""));
	...
	// 在目标数据表中检查数据项
	static BOOL CheckData (CString TableName, CString Column, CString Params = _T(""), bool Console = false, CString Order = _T(""), CString Limit = _T(""), int SortMode = MOD_ASC, BOOL DISTINCT = FALSE, CString COUNT = _T(""), CString COLUMN = _T(""), CString GROUP = _T(""), CString HAVING = _T(""));
	...
	// 从目标数据表中求数据项和
	static BOOL SumData(CString TableName, CString Column, CString Params, double &SumData, bool Console = false);


	// 从目标数据表中求数据项积
	static BOOL ProductData(CString TableName, CString Column, CString Params, double &ProductData, bool Console = false);


	// 从目标数据表中求数据项平均数
	static BOOL AvgData(CString TableName, CString Column ,CString Params, double &AvgData, bool Console = false);


	// 从目标数据表中求数据项的众数
	static BOOL PluData(CString TableName, CString Column, CString Params, double &PluData, bool Console = false);


	// 从目标数据表中求数据项中位数
	static BOOL MidData(CString TableName, CString Column, CString Params, double &MidData, bool Console = false);


	// 从目标数据表中求数据项最大值
	static BOOL MaxData(CString TableName, CString Column, CString Params, double &MaxData, bool Console = false);


	// 从目标数据表中求数据项最小值
	static BOOL MinData(CString TableName, CString Column, CString Params, double &MinData, bool Console = false);


	// 从目标数据表中取数据项随机数
	static BOOL RandData(CString TableName, CString Column, CString Params, int &RanData, bool Console = false);
